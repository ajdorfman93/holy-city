        ...
        $slider.append(`
          <div class="aa-top-slider-single hebrew">
            ...
            <div class="aa-top-slider-content">
              <span class="aa-top-slider-catg" style="letter-spacing: 3px;">${f.Property_Status_Hebrew || 'Property'}</span>
               <a href="property_details.html?id=${property.id}"><h2 class="aa-top-slider-title hebrew">${f.Name_Hebrew || 'Untitled Property'}</h2></a>
              <p class="aa-top-slider-location" style="font-size: 18px"><i class="fa fa-map-marker"></i> ${f.Neighborhood_Hebrew || ''}</p>
