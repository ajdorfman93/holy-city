(function(factory) {
        ...
        function Slick(element, settings) {
            ...
            _.defaults = {
                ...
                customPaging: function(slider, i) {
                    return '<button type="button" data-role="none" role="button" ' +
                           'aria-required="false" tabindex="0">' + (i + 1) + '</button>';
                },
                dots: false,
    ...
    Slick.prototype.buildArrows = function() {
        ...
        if (_.$prevArrow) {
            _.$prevArrow.css('color', '#627f9b');
        }
        if (_.$nextArrow) {
            _.$nextArrow.css('color', '#627f9b');
        }
    };
    ...
    Slick.prototype.changeSlide = function(event, dontAnimate) {
        ...
        // If target is not the <li> (dots), find the <li>.
        if (!$target.is('li')) {
    ...
    Slick.prototype.destroy = function(refresh) {
        ...
        _.cleanUpRows();
        _.$slider.removeClass('slick-slider slick-initialized');
        _.unslicked = true;
    ...
    Slick.prototype.keyHandler = function(event) {
        var _ = this;
        // Don’t slide if the cursor is inside a form field.
    ...
    Slick.prototype.lazyLoad = function() {
        ...
        if (_.options.centerMode === true) {
            ...
            rangeStart = _.options.infinite
                ? _.options.slidesToShow + _.currentSlide : _.currentSlide;
    ...
    Slick.prototype.progressiveLazyLoad = function() {
        ...
        if (imgCount > 0) {
            ...
            targetImage.attr('src', targetImage.attr('data-lazy'))
                .removeClass('slick-loading').load(function() {
    ...
    Slick.prototype.refresh = function(initializing) {
        ...
        // ensure new breakpoint can handle the "current slide"
        ...
        if (_.options.centerMode === true) {
            ...
            if (_.options.infinite === true) {
                if (index >= centerOffset &&
                    ...
                    allSlides
                        .slice(indexOffset - centerOffset + 1,
    ...
    Slick.prototype.swipeMove = function(event) {
        ...
        _.touchObject.curX = touches !== undefined
            ? touches[0].pageX : event.clientX;
        _.touchObject.curY = touches !== undefined
            ? touches[0].pageY : event.clientY;
        ...
        if (_.options.vertical === false) {
            ...
            _.swipeLeft = curLeft + (swipeLength
                * (_.$list.height() / _.listWidth)) * positionOffset;
        }
        if (_.options.verticalSwiping === true) {
            _.swipeLeft = curLeft + swipeLength * positionOffset;
        }
    ...
    $.fn.slick = function() {
        var _ = this, opt = arguments[0], args = Array.prototype.slice.call(arguments, 1),
            l = _.length, i, ret;
        for (i = 0; i < l; i++) {
